...
4.ดู ไฟล์งาน แล้วดูโครงว่าต้องส่วนไหนก่อน โดยเริ่มแรกจะสร้างส่วนกล่อง <header></header> ที่ส่วน css :Body และ header {} ที่ไฟล์ style.css
        ...
        ***หมายเหตุ ต้องเปลี่ยนเป็น Grid แล้ว แบ่ง ซ้าย ขวา จากนั้น ซ้ายปกติ ส่วนขวามีลูก 3 คน ต้องทำให้ .content_1-2-1, .content_1-2-2, .content_1-2-3 เป็นพี่น้องกัน